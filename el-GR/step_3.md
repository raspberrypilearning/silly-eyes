...
![Ένας χαρακτήρας με αστεία μάτια.](images/character-with-eyes.png)
{:width="300px"}  
...
![Τα ρυθμιστικά κορεσμού και φωτεινότητας ορίστηκαν στο 0.](images/black-colour.png)
![Τα ρυθμιστικά κορεσμού και φωτεινότητας ορίστηκαν στο 100.](images/white-colour.png)
