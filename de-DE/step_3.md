...
<span style="color: #0faeb0">**Benutzer** oder **Nutzer**</span> bezeichnet die Person, die das Projekt verwendet (nicht nur erstellt), und <span style="color: #0faeb0">**Benutzerinteraktion** oder **Nutzerinteraktion**</span> gibt an, wie das Projekt auf Aktionen des Benutzers reagiert, z. B. wenn dieser die Maus bewegt oder auf dem Bildschirm klickt. 
</p>
